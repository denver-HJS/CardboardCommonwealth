...
export default ngModule => {
  ...
  class mappingService {
    ...
    mapInspectionRequest(dataSrc)
    {
      ...
      mapObj.inspectorPieceDimensions = [];
      vm.mapProp(mapObj, dataSrc.currentInspection, "totGrossVolume", "totGrossVolume", "");
      vm.mapProp(mapObj, dataSrc.currentInspection, "totDensity", "totDensity", "");
      ...
      mapObj.inspectionContext = dataSrc.inspectionContext; // Nested Object
    ...
    mapUpdateInspectorDimRequest(dataSrc)
    {
      ...
      vm.mapProp(mapObj, dataSrc.currentInspection, "inspectionDateTime", "inspectionDateTime", "");
      mapObj.inspectionContext = dataSrc.inspectionContext; // Nested Object
      vm.mapProp(mapObj, dataSrc.inspectionDetails.totGrossVolume, "totGrossVolume", "totGrossVolume", "");
      vm.mapProp(mapObj, dataSrc.inspectionDetails.totDensity, "totDensity", "totDensity", "");
      mapObj.inspectorPieceDimensions = dataSrc.inspectionDetails.inspectorPieceDimensions; // Nested Array
      return mapObj;
    }
